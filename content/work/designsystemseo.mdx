...
Company: Copenhagen-based SEO SaaS startup  
Role: Lead Design System Designer  
Team: 1 Product Manager, 4 Developers, 1 Marketing Strategist  
Duration: 2 months (concept → rollout)
...
1. Foundations – tokens, type system, grids, accessibility standards
2. Core Components – buttons, forms, inputs, navigation, modals, icons
3. Application UI – dashboards, audit reports, keyword tables
4. Marketing System – modular website templates
5. Documentation & Rollout – guidelines, Figma libraries, governance
